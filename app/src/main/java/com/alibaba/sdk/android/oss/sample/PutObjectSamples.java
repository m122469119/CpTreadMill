...
public class PutObjectSamples {
    ...
    // 从本地文件上传，使用非阻塞的异步接口
    public void asyncPutObjectFromLocalFile(OSSCompletedCallback<PutObjectRequest, PutObjectResult> ossCallback) {
        // 构造上传请求
        PutObjectRequest put = new PutObjectRequest(testBucket, testObject, uploadFilePath);
        ...
        OSSAsyncTask task = oss.asyncPutObject(put, ossCallback);
    }
