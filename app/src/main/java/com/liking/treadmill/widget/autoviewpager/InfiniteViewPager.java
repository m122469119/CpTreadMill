package com.liking.treadmill.widget.autoviewpager;
...
//                log("onPageScrollStateChanged->" + sta);
        ...
        if (this.mAutoScroll || this.mTouchedWhenAutoScroll) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_DOWN:
                    LogUtils.d("aaron", "onInterceptTouchEvent down");
                    this.mTouchedWhenAutoScroll = true;
                    stopAutoScroll();
                    break;
                case MotionEvent.ACTION_UP:
                    LogUtils.d("aaron", "onInterceptTouchEventt up");
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (this.mAutoScroll || this.mTouchedWhenAutoScroll) {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN:
                    LogUtils.d("aaron", "onTouchEvent down");
                    this.mTouchedWhenAutoScroll = true;
                    stopAutoScroll();
                    break;
                case MotionEvent.ACTION_UP:
                    LogUtils.d("aaron", "onTouchEvent up");
                    this.mTouchedWhenAutoScroll = false;
                    startAutoScroll();
                    break;
            }
