...
public class TimeWheelView extends ScrollView {
    ...
    private void init(Context context) {
        ...
        mTypeFace = Typeface.createFromAsset(context.getAssets(), "fonts/Impact.ttf");
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            itemView.setTextColor(ResourceUtils.getColor(R.color.white));
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(ResourceUtils.getColor(R.color.c35EA81));
