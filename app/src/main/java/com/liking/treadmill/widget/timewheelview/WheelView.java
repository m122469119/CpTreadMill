...
/**
 * @brief Rolling wheel view.
 * 
 * @author Teemo
 *
 * @date 2015-10-13 下午2:58:47
 */
public class WheelView extends View {
    ...
    /** Wheel view background drawabel */
    private int wheelBackground = R.drawable.shape_bg_wheel_ve;

    /** Wheel view fore drawabel */
...
//        circlePaint.setColor(Color.parseColor("#ff6868"));
...
//        circlePaint.setStyle(Style.STROKE);
        ...
        linePaint = new Paint();
        linePaint.setColor(ResourceUtils.getColor(R.color.c35EA81));
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(wheelBackground);
        }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // 绘制上边直线
        canvas.drawLine(getPaddingLeft(), center - offset, getWidth() - getPaddingRight(), center - offset, linePaint);
        // 绘制下边直线
        canvas.drawLine(getPaddingLeft(), center + offset, getWidth() - getPaddingLeft() , center + offset, linePaint);
        // */

//        canvas.drawCircle(getWidth() / 2, center, 20 * DisplayUtils.getDensity(), circlePaint);
        //canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.bg_wheel_view_select), 0, center - offset, paint);
        /*centerDrawable.setBounds(0, center - offset, getWidth(), center + offset);
        centerDrawable.draw(canvas);*/
        canvas.drawText("min", getWidth() / 2 + 20 * DisplayUtils.getDensity(), center+ (offset / 3), textPaint);
    }
